...
"use strict";function createMap(){var e=[{placeName:"New York, Metropolitan Opera House",lat:40.7731527,lng:-73.98493630000002}],o=e[Math.floor(Math.random()*e.length)],a={disableDefaultUI:!0,maxZoom:25,zoom:15,mapTypeId:google.maps.MapTypeId.ROADMAP,center:{lat:o.lat,lng:o.lng},disableDoubleClickZoom:!0};map=new google.maps.Map(document.querySelector("#map"),a);var t=null;google.maps.event.addListener(map,"click",function(e){t=setTimeout(function(){},200)});var n=function(e){return new google.maps.Marker({position:e,map:map,title:"NewLocation"})};google.maps.event.addListener(map,"dblclick",function(e){clearTimeout(t),viewModel.addLocation(e.latLng,n(e.latLng)),e.stop()})}function getLocation(e){var o=new google.maps.places.PlacesService(map);o.textSearch({query:e},function(e,o){o==google.maps.places.PlacesServiceStatus.OK&&(console.log(e[0].geometry.location.lat()),console.log(e[0].geometry.location.lng()))})}var map=null,mapBounds=null;window.addEventListener("load",createMap),window.addEventListener("resize",function(e){map.fitBounds(mapBounds)});